...
基于 Telethon + Docker Compose 的 Telegram 下载机器人。本bot是对 [ARPT-Bot](https://github.com/666wcy/ARPT-Bot)这个项目的复刻 ，因为原项目已停止更新且无法运行。
...
JMComic 功能基于 [jmcomic](https://github.com/hect0x7/JMComic-Crawler-Python) 库，无需额外配置。

| 命令 | 说明 |
|---------|-------------|
| /jm <id> | 查询漫画信息，选择操作模式 |
| /jms <name> | 按名称搜索漫画 |
| /jmi <id> | 显示漫画封面 + 详细信息 + 操作按钮 |

**三种输出模式：**
- **Send as Album**：分批发为 Telegram 相册（每组最多 10 张，自动转换 webp）
- **Upload to Cloud**：打包为 ZIP（文件名 jmid_漫画ID_标题_作者.zip）上传到网盘
- **Send ZIP to TG**：打包为 ZIP 直接发送到 Telegram
...
原项目 [666wcy/ARPT-Bot](https://github.com/666wcy/ARPT-Bot) 是功能丰富的 Telegram 下载机器人
