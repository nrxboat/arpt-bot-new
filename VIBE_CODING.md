...
arpt-bot/
  ...
  bot/
    ...
    services/
      jmcomic_client.py     ?JMComic download & search
...
- [ ] Netease Cloud Music
- [x] JMComic doujinshi download (Album/upload/TG)
...
| /jm <id> | ✨ | JMComic doujinshi download (Album/upload/TG) |
| /jms <name> | ✨ | Search JMComic albums by name |
| /jmi <id> | ✨ | Show album cover + info + action buttons |
